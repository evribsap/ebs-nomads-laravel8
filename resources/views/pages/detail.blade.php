            ...
            <div class="row">
                <div class="col-lg-8 pl-lg-0">
                    <div class="card card-details">
                        ...
                        <p>
                            Nusa Penida adalah sebuah kota yang terletak di pulau Nusa Tenggara, Indonesia.
                            Kota ini terletak di sebelah barat laut Pulau Nusa Tenggara.
                            Kota ini memiliki kawasan yang terdiri dari beberapa pulau dan sebuah pulau yang berada di sebelah barat laut Pulau Nusa Tenggara.
                        </p>
                        <p>
                            Nusa Penida terletak di sebelah barat laut Pulau Nusa Tenggara.
                            Kota ini memiliki kawasan yang terdiri dari beberapa pulau dan sebuah pulau yang berada di sebelah barat laut Pulau Nusa Tenggara.
                        </p>
...
@push('addon-script')
<script src="{{ url('frontend/libraries/xzoom/xzoom.min.js') }}"></script><script src="frontend/libraries/xzoom/xzoom.min.js"></script>
<script>
